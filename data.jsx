// data.jsx — Workout Buddy fake data + helpers
// PUSH/PULL/LEGS rotation, 3 sets per exercise, lived-in history.
...
// History — most recent first. "Lived-in" = mid-week, 2 done, 1 active feel.
// Today is Wed Apr 29, 2026.
const HISTORY = [
  {
    id: 'h-2026-04-27',
    splitKey: 'pull',
...
// Determine the next split based on most recent.
...
// Sessions completed this week (Mon Apr 27 - today Wed Apr 29 of week).
// Week starts Mon. This week so far: Pull (Mon Apr 27). Goal 4.
const THIS_WEEK = {
  completed: 1,
  goal: 4,
  days: [
...
window.WB_DATA = {
  SPLITS, ROTATION, HISTORY, THIS_WEEK, STREAK,
  getNextSplit, getMotivation, MOTIVATIONS,
};
